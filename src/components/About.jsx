...
const About = () => {
  return (
    <>
      ...
      >
       Hello! I'm a React Native App developer,
        passionate about creating exceptional mobile experiences. 
        With a strong background in front-end development, 
        I craft seamless and intuitive cross-platform applications. 
       Let's build something remarkable together! Explore my portfolio and get in touch.
      </motion.p>
